...
# 29 "main.c" 2
# 1 "playerBlastSpritesheet.h" 1
# 22 "playerBlastSpritesheet.h"
extern const unsigned short playerBlastSpritesheetTiles[16384];


extern const unsigned short playerBlastSpritesheetMap[1024];


extern const unsigned short playerBlastSpritesheetPal[256];
# 30 "main.c" 2
# 1 "bgLose.h" 1
# 22 "bgLose.h"
extern const unsigned short bgLoseTiles[1248];
...
extern ANISPRITE health[10];
extern ANISPRITE text[4];
extern ANISPRITE lives[10];
extern ANISPRITE smallHealthPickup[10];
extern ANISPRITE largeHealthPickup[10];
extern ANISPRITE playerBullets[3];
extern ANISPRITE moleGuys[10];
extern ANISPRITE moleBullets[20];
extern ANISPRITE sniperJoes[10];
extern ANISPRITE joeBullets[20];
extern ANISPRITE horiOctoEyes[10];
extern ANISPRITE vertOctoEyes[10];
...
extern const unsigned int restSong_sampleRate;
extern const unsigned int restSong_length;
extern const signed char restSong_data[];
# 39 "main.c" 2
# 1 "loseSong.h" 1
...
# 1 "parallaxSky.h" 1
# 22 "parallaxSky.h"
extern const unsigned short parallaxSkyTiles[768];


extern const unsigned short parallaxSkyMap[2048];


extern const unsigned short parallaxSkyPal[256];
# 44 "main.c" 2
# 1 "levelOne.h" 1
# 22 "levelOne.h"
...
# 1 "levelThree.h" 1
# 22 "levelThree.h"
extern const unsigned short levelThreeTiles[4576];


extern const unsigned short levelThreeMap[2048];
...
# 1 "levelFour.h" 1
# 22 "levelFour.h"
extern const unsigned short levelFourTiles[6064];


extern const unsigned short levelFourMap[2048];


extern const unsigned short levelFourPal[256];
# 49 "main.c" 2
# 1 "levelFive.h" 1
# 22 "levelFive.h"
extern const unsigned short levelFiveTiles[6128];


extern const unsigned short levelFiveMap[2048];


extern const unsigned short levelFivePal[256];
# 50 "main.c" 2
...
void initialize()
{
    ...
    (*(volatile unsigned short *)0x4000008) = (1 << 14) | ((28) << 8) | ((2) << 2) | (0 << 7);
...
void goToStart() {
    ...
    DMANow(3, bgStartTiles, &((charblock *)0x6000000)[1], 5216 / 2);
    DMANow(3, bgStartMap, &((screenblock *)0x6000000)[30], 2048 / 2);
    DMANow(3, bgStartTiles, &((charblock *)0x6000000)[2], 5216 / 2);
...
void goToGame() {
    ...
    if(levelsCleared == 0) {
        DMANow(3, levelOnePal, ((unsigned short *)0x5000000), 512 / 2);
    }
    if(levelsCleared == 1) {
        DMANow(3, levelTwoPal, ((unsigned short *)0x5000000), 512 / 2);
    }
    if(levelsCleared == 2) {
        DMANow(3, levelThreePal, ((unsigned short *)0x5000000), 512 / 2);
    }
    if(levelsCleared == 3) {
        DMANow(3, levelFourPal, ((unsigned short *)0x5000000), 512 / 2);
    }
    if(levelsCleared == 4) {
        DMANow(3, levelFivePal, ((unsigned short *)0x5000000), 512 / 2);
    }



    DMANow(3, parallaxSkyTiles, &((charblock *)0x6000000)[1], 1536 / 2);
 DMANow(3, parallaxSkyMap, &((screenblock *)0x6000000)[30], 4096 / 2);


    if(levelsCleared == 0) {
        DMANow(3, levelOneTiles, &((charblock *)0x6000000)[2], 4736 / 2);
     DMANow(3, levelOneMap, &((screenblock *)0x6000000)[28], 4096 / 2);
    }
    if(levelsCleared == 1) {
        DMANow(3, levelTwoTiles, &((charblock *)0x6000000)[2], 11136 / 2);
     DMANow(3, levelTwoMap, &((screenblock *)0x6000000)[28], 4096 / 2);
    }
    if(levelsCleared == 2) {
        DMANow(3, levelThreeTiles, &((charblock *)0x6000000)[2], 9152 / 2);
     DMANow(3, levelThreeMap, &((screenblock *)0x6000000)[28], 4096 / 2);
    }
    if(levelsCleared == 3) {
        DMANow(3, levelFourTiles, &((charblock *)0x6000000)[2], 12128 / 2);
     DMANow(3, levelFourMap, &((screenblock *)0x6000000)[28], 4096 / 2);
    }
    if(levelsCleared == 4) {
        DMANow(3, levelFiveTiles, &((charblock *)0x6000000)[2], 12256 / 2);
     DMANow(3, levelFiveMap, &((screenblock *)0x6000000)[28], 4096 / 2);
    }




    DMANow(3, playerBlastSpritesheetTiles, &((charblock *)0x6000000)[4], 32768 / 2);
    DMANow(3, playerBlastSpritesheetPal, ((unsigned short *)0x5000200), 512 / 2);
...
void game() {
    updateGame();
    drawGame();
    if((!(~(oldButtons) & ((1 << 3))) && (~buttons & ((1 << 3)))) && winTimer >= 300 && cheatTimer <= 0 && deathTimer <= 0 && deathTranTimer <= -10) {
        goToPause();
    }
...
void goToPause() {
    ...
    DMANow(3, bgPauseTiles, &((charblock *)0x6000000)[1], 10816/2);
    DMANow(3, bgPauseMap, &((screenblock *)0x6000000)[30], 2048/2);
    DMANow(3, bgPauseTiles, &((charblock *)0x6000000)[2], 10816/2);
...
void goToLose() {
    ...
    DMANow(3, bgLoseTiles, &((charblock *)0x6000000)[1], 2496/2);
    DMANow(3, bgLoseMap, &((screenblock *)0x6000000)[30], 2048/2);
    DMANow(3, bgLoseTiles, &((charblock *)0x6000000)[2], 2496/2);
...
void goToComplete() {
    ...
    (*(volatile unsigned short *)0x04000014) = 0;
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), (4*128));
    DMANow(3, bgCompletePal, ((unsigned short *)0x5000000), 256 );
    DMANow(3, bgCompleteTiles, &((charblock *)0x6000000)[1], 2912/2);
    DMANow(3, bgCompleteMap, &((screenblock *)0x6000000)[30], 2048/2);
    DMANow(3, bgCompleteTiles, &((charblock *)0x6000000)[2], 2912/2);
    DMANow(3, bgCompleteMap, &((screenblock *)0x6000000)[28], 2048/2);
    stopSound();
...
void goToWin() {
    ...
    (*(volatile unsigned short *)0x04000016) = 0;
    (*(volatile unsigned short *)0x04000014) = 0;
    shadowOAM[1].attr0 = (100) | (0 << 14);
    shadowOAM[1].attr1 = (136) | (0 << 14);
    if(playerLives < 3) {
        shadowOAM[1].attr2 = ((0) << 12) | ((29)*32 + (18));
    }
    else if(playerLives == 3) {
        shadowOAM[1].attr2 = ((0) << 12) | ((29)*32 + (17));
    }
    else if(playerLives > 3 && usedCheat == 0) {
        shadowOAM[1].attr2 = ((0) << 12) | ((30)*32 + (18));
    } else if (playerLives > 3) {
        shadowOAM[1].attr2 = ((0) << 12) | ((29)*32 + (16));
    }
    DMANow(3, shadowOAM, ((OBJ_ATTR *)(0x7000000)), (4*128));
    DMANow(3, bgWinPal, ((unsigned short *)0x5000000), 256 );
    DMANow(3, bgWinTiles, &((charblock *)0x6000000)[1], 3296/2);
    DMANow(3, bgWinMap, &((screenblock *)0x6000000)[30], 2048/2);
    DMANow(3, bgWinTiles, &((charblock *)0x6000000)[2], 3296/2);
...
void goToInstructions() {
    ...
    DMANow(3, bgInstructionsTiles, &((charblock *)0x6000000)[1], 7840/2);
    DMANow(3, bgInstructionsMap, &((screenblock *)0x6000000)[30], 2048/2);
    DMANow(3, bgInstructionsTiles, &((charblock *)0x6000000)[2], 7840/2);
